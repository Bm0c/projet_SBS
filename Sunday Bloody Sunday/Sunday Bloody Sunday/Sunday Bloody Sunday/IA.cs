...
namespace Sunday_Bloody_Sunday
{
    ...
    class IA
    {
        ...
        public IA(int x, int y, int id_texture, int id_son, int pv_max, int dégats)//ID texture, son joué, PV max, Vitesse
        {
            if (id_texture == 6)
            {
                pv_max = pv_max + 2000;// essai de tanker le tortank marche pas
                dégats = dégats / 2;
            }
            compteur_path = 0;
            ia_dir = 0;
            ...
            {
                ia_vol = true;
                this.IATexture = new Rectangle(x, y, 20, 20);//20
                IA.IAPosition = new Vector2(IATexture.X, IATexture.Y);
            }
            else if (id_texture == 4)
            {
        ...
        public void Animateattack()// animation de l'attack
        {
            this.Timer++;
            if (this.Timer == this.AnimationSpeed * 3)
            {
                this.Timer = 0;
                if (this.Animation)
                {
        ...
        public Rectangle IApoisiton2 = new Rectangle((int)IAPosition.X, (int)IAPosition.Y, 30, 30);//rectangle de l IA
        public void Draw(SpriteBatch spriteBatch, Rectangle Maptexture)
        {
            if (id_texture  == 4)
            {
                if (couldown < 59)
                {
                    spriteBatch.Draw(Ressources.IA1attack, new Rectangle(Maptexture.X + IATexture.X, Maptexture.Y + IATexture.Y, IATexture.Width, IATexture.Width), new Rectangle((this.frameColumn - 1) * 30, (this.frameLine - 1) * 25, 30, 25), Color.White, 0f, new Vector2(0, 0), this.Effect, 0f);
            ...
            else if (id_texture == 2)
            {
                if (couldown < 59)
                {
                    spriteBatch.Draw(Ressources.IA3attack, new Rectangle(Maptexture.X + IATexture.X, Maptexture.Y + IATexture.Y, IATexture.Width, IATexture.Width), new Rectangle((this.frameColumn - 1) * 22, (this.frameLine - 1) * 17, 24, 24), Color.White, 0f, new Vector2(0, 0), this.Effect, 0f);
                }
                else
                {
                    spriteBatch.Draw(Ressources.IA3, new Rectangle(Maptexture.X + IATexture.X, Maptexture.Y + IATexture.Y, IATexture.Width, IATexture.Width), new Rectangle((this.frameColumn - 1) * 40, (this.frameLine - 1) * 45, 24, 24), Color.White, 0f, new Vector2(0, 0), this.Effect, 0f);
                }
            }
            else if (id_texture == 3)
            {
                if (couldown < 59)
                {
                    spriteBatch.Draw(Ressources.IA4attack, new Rectangle(Maptexture.X + IATexture.X, Maptexture.Y + IATexture.Y, IATexture.Width, IATexture.Width), new Rectangle((this.frameColumn - 1) * 45, (this.frameLine - 1) * 40,26, 30), Color.White, 0f, new Vector2(0, 0), this.Effect, 0f);
            ...
            else if (id_texture == 0)
            {
                if (couldown < 59)
                {
                    spriteBatch.Draw(Ressources.IA5attack, new Rectangle(Maptexture.X + IATexture.X, Maptexture.Y + IATexture.Y, IATexture.Width, IATexture.Width), new Rectangle((this.frameColumn - 1) * 27, (this.frameLine - 1) * 29, 27, 29), Color.White, 0f, new Vector2(0, 0), this.Effect, 0f);
                }
                else
                {
                    spriteBatch.Draw(Ressources.IA5, new Rectangle(Maptexture.X + IATexture.X, Maptexture.Y + IATexture.Y, IATexture.Width, IATexture.Width), new Rectangle((this.frameColumn - 1) * 30, (this.frameLine - 1) * 29, 30, 29), Color.White, 0f, new Vector2(0, 0), this.Effect, 0f);

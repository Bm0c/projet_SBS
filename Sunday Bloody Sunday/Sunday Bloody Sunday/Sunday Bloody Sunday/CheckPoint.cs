...
namespace Sunday_Bloody_Sunday
{
    class CheckPoint
    {
        ...
        public CheckPoint(int x, int y, string type)
        {
            ...
            this.CheckPointBossEntry = new Rectangle(x, y, 10, 5);
            this.type = type;
        }
        ...
        public void Draw(SpriteBatch spriteBatch, Rectangle MapTexture)
        {
            switch (type)
            {
                case ("arrivee"):
                    ...
                    break;
                case ("bossentry"):
                    spriteBatch.Draw(Ressources.mBossEntry, new Rectangle(this.CheckPointBossEntry.X + MapTexture.X, this.CheckPointBossEntry.Y + MapTexture.Y, 16, 18), Color.CadetBlue);
                    break;
                default:
                    break;
            }
